  ...
  return (
    <>
      ...
      {session ? (
        <>
          <button
            className="py-1 px-2 border-none bg-gray-50 dark:text-grayNew-300 dark:bg-grayNew-650 dark:font-medium"
            onClick={() => {
        ...
        <>
          <button
            className="py-1 px-2 border-none bg-gray-50 dark:text-grayNew-800 dark:font-medium"
            onClick={() => {
